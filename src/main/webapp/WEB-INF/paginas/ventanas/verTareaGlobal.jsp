<div class="modal fade" id="verTareaGlobal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title">Tarea Global</h5> 
            ...
            <form action="" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-floating py-2">
                        <input type="text" class="form-control" id="designado" readonly>
                    ...
                    <div class="form-floating py-2">
                        ...
                        <label class="form-check-label" for="floatingInput">Nombre del dueño</label>
                    </div>
                    <div class="form-floating py-2">
