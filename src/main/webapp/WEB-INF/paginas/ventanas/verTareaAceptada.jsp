...
<div class="modal fade" id="verTareaAceptada">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-info text-white">
                <h5 class="modal-title">Ver Tarea Aceptadas</h5> 
            ...
            <form action="" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-floating py-2">
                        <input type="text" class="form-control" id="estatus" placeholder="name@example.com" readonly>
                        <label class="form-check-label" for="gridRadios1">Estatus</label>
                    </div>
                </div>
            </form> 
        </div>
